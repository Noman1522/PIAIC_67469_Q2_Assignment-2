...
def function7():
    ...
    zu = np.zeros(4, dtype=np.int64)
    zu
  
    return zu #write your code here
...
def function8():
    ...
    x = np.full((2,6),6)  #write your code here
...
def function11():
    ...
    ans = np.asarray(arr)
    ans = ans[1::2]= -1 #write your code here 
...
def function18():
    ...
    x = y = [1 if x in piaic else 0 for x in students]
    y = np.count_nonzero # Write you code Here
    return x
